...
FAILURE_MODES: list[FailureMode] = [
    ...
    FailureMode(
        ...
        description=(
            ...
            "- Check whether the rubric provides ANY anchoring attempt such as: concrete checklists "
            "('includes X/Y/Z'), measurable thresholds (word count, required sections, required elements), "
